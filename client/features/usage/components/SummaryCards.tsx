...
const SummaryCards = ({ summary, plan }: Props) => {
  return (
    <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
      ...
      <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-4">
        <h2 className="text-3xl font-bold">{summary.avg_daily.toFixed(1)}</h2>
      ...
      <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-4">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">{new Date(summary.peak_day.date).toLocaleString('default', { month: 'short', day: '2-digit' })}</p>
      </div>
      <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-4">
